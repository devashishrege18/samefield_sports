    ...
    return (
        <div className="forum-container page-frame background-texture">
            ...
            <div className="forum-layout">
                ...
                {/* INLINE SIDEBAR CONTENT - Compact Row */}
                <div className="forum-footer">
                    <div className="flex flex-wrap items-center gap-4 p-4 bg-surface/50 rounded-xl border border-surfaceHighlight">
                        <div className="flex items-center gap-2">
                            <Radio size={14} className="text-red-500 animate-pulse" />
                            <span className="text-xs font-bold text-white">India vs Australia</span>
                            <span className="text-[8px] bg-red-500 text-white px-1.5 py-0.5 rounded font-bold">LIVE</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <Radio size={14} className="text-red-500 animate-pulse" />
                            <span className="text-xs font-bold text-white">Mumbai vs Chennai</span>
                            <span className="text-[8px] bg-red-500 text-white px-1.5 py-0.5 rounded font-bold">LIVE</span>
                        </div>
                        <div className="border-l border-surfaceHighlight h-4 mx-2" />
                        <div className="flex items-center gap-2 text-[10px] text-textMuted">
                            <span className="text-primary">#WPL2025</span>
                            <span className="text-primary">#ViratKohli</span>
                            <span className="text-primary">#MixedCricket</span>
                        </div>
                    </div>
                </div>
            </div>

...
export const circleMedia = {
    'c1': [
        { id: 'm1', type: 'image', url: '/assets/smriti_in_action.png', title: 'Smriti in Action' },
        { id: 'm2', type: 'video', vidId: '_Hlq_TaPoYw', title: 'Match Highlight' },
        { id: 'm3', type: 'image', url: '/assets/training_session.png', title: 'Training Session' }
    ],
    'c5': [
        { id: 'm4', type: 'image', url: '/assets/king_kohli_vibes.png', title: 'King Kohli' },
        { id: 'm5', type: 'video', vidId: 'NsZ-BiPzmOw', title: 'Haaland vs Neymar' },
        { id: 'm6', type: 'image', url: '/assets/the_grind.png', title: 'Equipments' }
    ],
    'default': [
        { id: 'd1', type: 'image', url: '/assets/community_spirit.png', title: 'Community Spirit' },
        { id: 'd2', type: 'image', url: '/assets/the_grind.png', title: 'The Grind' }
    ]
};

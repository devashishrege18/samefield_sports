            ...
            <div className="forum-layout">
                            ...
                            {threads.map(thread => (
                                <div key={thread.id} className={`thread-card ${thread.isLive ? 'live-thread' : ''}`}>
                                    <div className="vote-column">
                                        <button className="btn-vote" onClick={handleUpvote}><ArrowUp size={18} /></button>
                                    ...
                                    <div className="thread-content">
                                        ...
                                        <div className="thread-actions">
                                            <div className="action-pill" onClick={handleJoinDebate}><MessageSquare size={14} /> {thread.comments} Comments</div>
                ...
                <div className="forum-sidebar">
                    <div className="sidebar-card live-now">
                        ...
                        <button className="btn-join-live" onClick={handleJoinDebate}>Join Live Chat</button>
                    </div>

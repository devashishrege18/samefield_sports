...
const BlockbusterPurposeModal = () => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] bg-black overflow-hidden font-outfit select-none flex flex-col items-center justify-center">
            ...
            {/* BACKGROUND: High-Density Texture Wall (Vibrancy Restored) */}
            ...
            {/* FOREGROUND: Core Content Layer (Normalized Proportions for 90% Balance) */}
            <div className="relative z-10 w-full max-w-4xl px-6 flex flex-col items-center text-center space-y-8 animate-blockbuster-entry">

                {/* TEXT HIERARCHY: Corrected Scaling (8xl for premium balance) */}
                <div className="space-y-4">
                    ...
                    {/* Body Text: Human-Written Statement (Scaled for Breathing Room) */}
                    <div className="max-w-2xl mx-auto pt-2">
                        <p className="text-base md:text-xl font-medium text-gray-200 tracking-tight leading-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                ...
                {/* PROCESS: Minimalist Icons (Tightened Proportions) */}
                ...
                {/* CTA: Standardized Confidence (Proportional Fit) */}
                <div className="pt-2">
                    <button

...
const BlockbusterPurposeModal = () => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] bg-black overflow-hidden font-outfit select-none flex flex-col items-center justify-center">
            ...
            {/* FOREGROUND: Core Content Layer (80% Zoom Normalization for Default 100% View) */}
            <div className="relative z-10 w-full max-w-5xl px-6 flex flex-col items-center text-center space-y-8 md:space-y-12 animate-blockbuster-entry">

                {/* TEXT HIERARCHY: Corrected Scaling (Aesthetic Balance) */}
                <div className="space-y-6">
                    ...
                    <h1 className="text-7xl md:text-8xl font-black text-white tracking-tighter leading-[0.85] uppercase drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)] bg-gradient-to-b from-white to-white/70 bg-clip-text text-transparent transform md:scale-95">
                        Watch. Support.<br />
                        <span className="text-primary italic drop-shadow-[0_2px_10px_rgba(255,215,0,0.3)]">Elevate.</span>
                    </h1>

                    {/* Body Text: Human-Written Clean Statement (80% Aesthetic) */}
                    <div className="max-w-3xl mx-auto pt-3">
                        <p className="text-xl md:text-2xl font-medium text-gray-200 tracking-tight leading-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                ...
                {/* CTA: Final Production Refinement (80% Aesthetic) */}
                <div className="pt-2">
                    <button
